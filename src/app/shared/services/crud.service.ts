...
EAdhar(adhardetails: any): Observable<any> {
  return this.http.post(`${environment.apiUrl}/eaadhaarotp`, adhardetails);
}
EAdharfile(additionalData: any): Observable<any> {
  return this.http.post(`${environment.apiUrl}/eaadhaarFile`, additionalData);
}
voterocr(VoterOcrData: any): Observable<any> {
  return this.http.post(`${environment.apiUrl}/ocrkyc`, VoterOcrData);
}
