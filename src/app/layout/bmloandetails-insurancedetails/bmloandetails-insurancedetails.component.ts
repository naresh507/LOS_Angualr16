...
@Component({
  selector: 'app-bmloandetails-insurancedetails',
  templateUrl: './bmloandetails-insurancedetails.component.html',
  styleUrls: ['./bmloandetails-insurancedetails.component.scss']
})
export class BMloandetailsInsurancedetailsComponent {

  @Output() BMinsurance = new EventEmitter()
