...
@Component({
  selector: 'app-bmloandetails-bankdetails',
  templateUrl: './bmloandetails-bankdetails.component.html',
  styleUrls: ['./bmloandetails-bankdetails.component.scss']
})
export class BMloandetailsBankdetailsComponent {
  ...
  Save(formData: any){
    this.route.navigateByUrl('/bmcgtdetails')
    console.log(formData.value)
    ...
    formData.value['cameraimage'] = cameraimage;
