...
@Component({
  selector: 'app-bmloandetails-hhloan',
  templateUrl: './bmloandetails-hhloan.component.html',
  styleUrls: ['./bmloandetails-hhloan.component.scss']
})
export class BMloandetailsHhloanComponent {
