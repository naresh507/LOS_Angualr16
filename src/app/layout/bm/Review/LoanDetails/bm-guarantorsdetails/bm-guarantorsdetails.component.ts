...
@Component({
  selector: 'app-bm-guarantorsdetails',
  templateUrl: './bm-guarantorsdetails.component.html',
  styleUrls: ['./bm-guarantorsdetails.component.scss']
})
export class BmGuarantorsdetailsComponent {
