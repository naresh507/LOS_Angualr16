...
@Component({
  selector: 'app-bmhhloaneligibility',
  templateUrl: './bmhhloaneligibility.component.html',
  styleUrls: ['./bmhhloaneligibility.component.scss']
})
export class BmhhloaneligibilityComponent {
  LosUnique_Id: any = {};
  form!:FormGroup;
  userObj:any;
  HLoan:any;
