...
@Component({
  selector: 'app-bmcashflowdetails',
  templateUrl: './bmcashflowdetails.component.html',
  styleUrls: ['./bmcashflowdetails.component.scss']
})
export class BmcashflowdetailsComponent {
