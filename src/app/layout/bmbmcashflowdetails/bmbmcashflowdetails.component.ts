...
@Component({
  selector: 'app-bmbmcashflowdetails',
  templateUrl: './bmbmcashflowdetails.component.html',
  styleUrls: ['./bmbmcashflowdetails.component.scss']
})
export class BMbmcashflowdetailsComponent {
