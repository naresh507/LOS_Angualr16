...
@Component({
  selector: 'app-kycprofilereview',
  templateUrl: './kycprofilereview.component.html',
  styleUrls: ['./kycprofilereview.component.scss']
})
export class KycprofilereviewComponent implements OnInit{
