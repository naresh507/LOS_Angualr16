...
@Component({
  selector: 'app-view-update-clientdetail',
  templateUrl: './view-update-clientdetail.component.html',
  styleUrls: ['./view-update-clientdetail.component.scss']
})
export class ViewUpdateClientdetailComponent {
